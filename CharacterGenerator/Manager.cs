...
namespace CharacterGenerator
{
	public class Manager
	{
		...
		public IEnumerable<Combination> GetAllValidCombinations(List<List<ImageMetadata>> parts, IEnumerable<IValidator> validators)
		{
		...
		public Combination[] Run(string personFolder, IEnumerable<IValidator> validators, Action<Combination, string> onValidComb)
		{
			...
			var allCombinations = GetAllValidCombinations(parts, validators).ToList();
